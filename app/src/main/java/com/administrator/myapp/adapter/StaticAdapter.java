...
public class StaticAdapter extends BaseAdapter {
    ...
    public StaticAdapter(Context context, List<String> list_1, List<String> list_2, List<String> list_3, List<String> list_4) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        StaticAdapter.ViewHolder vh;
        if(convertView==null){
            vh=new StaticAdapter.ViewHolder();
            ...
            vh= (StaticAdapter.ViewHolder) convertView.getTag();
        }
        ...
        View view = layoutInflater.inflate(R.layout.datea_3, null);
        TextView textleft = (TextView) view.findViewById(R.id.nt);
        textleft.setText("报警次数：123");
    ...
    public void updataView(int posi, ListView listView, String dataValue_1, String dataValue_2, String dataValue_3, String dataValue_4) {
        ...
        if (posi >= visibleFirstPosi && posi <= visibleLastPosi) {
            ...
            StaticAdapter.ViewHolder holder = (StaticAdapter.ViewHolder) view.getTag();
