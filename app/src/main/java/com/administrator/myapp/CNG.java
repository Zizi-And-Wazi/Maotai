...
public class CNG extends AppCompatActivity {
    ...
    private static final String[] mMenus = {"CNG01","CNG02","CNG03","CNG04"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                initView();
                //刷新右边列表
                DBHelper_3 db = new DBHelper_3(context, mListView2, adapter2,selectIndex,mHandler);
                db.execute();
            }
        });
        new TimeThread().start(); //启动新的线程
        ...
        context = this;
        //刷新右边列表
        DBHelper_3 db = new DBHelper_3(context, mListView2, adapter2,0,mHandler);
        db.execute();
    }
